...
public class Client {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ResourceRegister registro=ResourceRegister.getinstance(); // serve per associare la risorsa con il suo descrittore
			
			registro.associateDescriptor(risorsa1, descrittoreRisorsa1);
			
			
			// MIO TEST NON CENTRA CON FIF_CORE
			ArrayList<Resource> ciao = registro.getSequence();
			for(Resource c: ciao)
				System.out.println(c.getUri().toASCIIString());
